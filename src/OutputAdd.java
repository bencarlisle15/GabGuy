...
public class OutputAdd extends Thread {
  ...
  public OutputAdd(Magpie ma, StyledDocument o, SimpleAttributeSet l, Main m,
                   Thread t, JTextPane ou) {
    mag = ma;
    out = o;
    left = l;
    main = m;
  ...
  private void checkMag() {
    ...
    if (checking) {
      // gets the response initially since getResponse makes the response null
      // afterwards
      ans = mag.getResponse();
